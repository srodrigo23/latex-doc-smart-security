...
\begin{figure}[H]
    \begin{center}
        ...
        \caption{Ilustración ejemplo de un fuego en interiores.} 
        Fuente: Web
        \label{fig:fuego}
    \end{center}
...
Referenciando a la figura \ref{fig:camaras}.
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=10cm]{img/capitulo_3/camaras.jpg}
        \caption{Variedad de cámaras de vigilancia.}
        Fuente: Web.
        \label{fig:camaras}
    \end{center}
\end{figure}

Referenciando a la figura \ref{fig:camara}.
\begin{figure}[H]
    \begin{center}
