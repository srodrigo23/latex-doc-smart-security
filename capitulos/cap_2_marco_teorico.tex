...
Lo más relevante en este crecimiento es la mejora en las características de este tipo de sistemas; gracias a la implementación de técnicas de visión por computadora e inteligencia artificial (I.A.), como a la escalabilidad debido al uso servicios basados en la nube. Las ramas de la inteligencia artificial como el Machine Learning(Aprendizaje Automático) y el Deep Learning(Aprendizaje profundo) permiten potenciar sus capacidades.\\
...
\begin{itemize}
    ...
    \item Servidor HTTP (Serviccio que emplea el protocolo Web)
    \item Módulo SMTP (Módulo de despacho de correo electrónico)
\end{itemize}
...
Estos protocolos son usados tanto en la comunicación analógica y la digital, y pueden ser usados en el procesos de transferencia de archivos y acceso a internet. Los tipos mas comunes de protocolos de comunicación incluyen:
...
<Resumir el oingreso del TCP/IP Y WEB>
