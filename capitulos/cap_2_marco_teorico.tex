...
Son un modelo computacional basado en un grán número de unidades (neuronas simples), de forma similar de lo que se ha observado en los axones de las neuronas de un cerebro biológico.
