...
\begin{figure}[H]
    ...
    \end{center}
    \begin{center}
        \caption{Diseño de interfaz - Módulo de cámara.}
        Fuente: Elaboración propia.
        \label{fig:cam_interface}
    \end{center}
\end{figure}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=16cm]{img/capitulo_4/movement_detection.jpg}
    \end{center}
    \begin{center}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=18cm]{img/capitulo_4/cam_connected_more_cams.png}
    \end{center}
    \begin{center}
        \caption{Diagrama de secuencia - Streamming de video en vivo.}
        Fuente: Elaboración propia.
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=18cm]{img/capitulo_4/cam_connected_no_more_cams.png}
    \end{center}
    \begin{center}
        \caption{Diagrama de secuencia - Streamming de video en vivo.}
        Fuente: Elaboración propia.
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=18cm]{img/capitulo_4/cam_disconnected_more_cams.png}
    \end{center}
    \begin{center}
        \caption{Diagrama de secuencia - Streamming de video en vivo.}
        Fuente: Elaboración propia.
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=18cm]{img/capitulo_4/cam_disconnected_no_more_cams.png}
    \end{center}
    \begin{center}
        \caption{Diagrama de secuencia - Streamming de video en vivo.}
        Fuente: Elaboración propia.
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=18cm]{img/capitulo_4/fire_detection_mail.png}
    \end{center}
    \begin{center}
        \caption{Diagrama de secuencia - Streamming de video en vivo.}
        Fuente: Elaboración propia.
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=18cm]{img/capitulo_4/human_detection_mail.png}
    \end{center}
    \begin{center}
        \caption{Diagrama de secuencia - Streamming de video en vivo.}
        Fuente: Elaboración propia.
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=18cm]{img/capitulo_4/movement_detection_mail.png}
    \end{center}
    \begin{center}
        \caption{Diagrama de secuencia - Streamming de video en vivo.}
        Fuente: Elaboración propia.
